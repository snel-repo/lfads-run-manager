...
outputFields = {'controller_outputs','factors', 'rates', 'generator_states', 'generator_ics', ...
    'costs','nll_bound_vaes', 'nll_bound_iwaes', 'post_g0_mean', ...
                'post_g0_logvar', 'mean_rates', 'controller_means'};
storedVariables = {'controller_outputs','factors','output_dist_params', 'gen_states', ...
    'gen_ics','costs','nll_bound_vaes','nll_bound_iwaes', 'post_g0_mean', ...
                   'post_g0_logvar', 'output_rates', 'co_mean_states'};
